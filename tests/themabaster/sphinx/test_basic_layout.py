...
class TestBasicLayoutDefaults:
    ...
    def test_titlesuffix(self, page):
        ...
        assert 'Hello World - Python' == node.contents[0].strip()
...
# class TestBasicLayoutHelloPage:
#     """ Check the second page to ensure it exists correctly """
#
#     def test_titlesuffix(self, page):
#         """ Jinja2 variable defined from docstitle global knob """
#
#         node: Tag = page.select_one('title')
#         assert 'The Hello Page - Python' == node.contents[0].strip()
#
#
# @pytest.mark.parametrize('page', ['index.html', ], indirect=True)
